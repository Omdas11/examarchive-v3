...
export default function ContributionHeatmap({
  ...
  const greens = [
    ...
    "color-mix(in srgb, var(--success-green) 20%, var(--color-surface))",  // 1 = light
    "color-mix(in srgb, var(--success-green) 45%, var(--color-surface))",  // 2
    "color-mix(in srgb, var(--success-green) 70%, var(--color-surface))",  // 3
    "var(--success-green)",            // 4 = deep
  ];
