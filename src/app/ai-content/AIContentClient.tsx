...
export default function AIContentClient({ userRole }: AIContentClientProps) {
  ...
  /** Escape HTML entities in a plain-text string to prevent XSS. */
...
<html>
<head>
  <title>${safeTitle} – ExamArchive AI</title>
  <style>
...
<body>
  ...
  function markdownToHtml(md: string): string {
    // Escape the raw AI text first, then re-apply safe Markdown headings/lists.
