...
export const MODEL_CAPABILITIES: Record<string, ModelCapability> = {
  ...
  "google/gemma-3-4b-it:free": {
    ...
    quality: "medium",
    cost: "low",
    description: "Gemma 3 4B instruction model prioritized for low-latency free runs.",
  },
  "google/gemma-3n-2b:free": {
    id: "google/gemma-3n-2b:free",
    label: "Gemma 3 Nano 2B (Free)",
    displayName: "Gemma 3 Nano 2B (Free)",
    speed: "fast",
    quality: "basic",
    cost: "low",
    description: "Tiny Gemma 3 Nano 2B for the quickest, lightweight drafts.",
  },
  "stepfun/step-3.5-flash:free": {
    ...
    quality: "medium",
    cost: "low",
    description: "StepFun 3.5 Flash tuned for fast, inexpensive completions.",
    badge: "Fastest",
  },
  "sourceful/riverflow-v2:free": {
    id: "sourceful/riverflow-v2:free",
    label: "Riverflow V2 (Free)",
    displayName: "Riverflow V2 (Free)",
    speed: "fast",
    quality: "medium",
    cost: "low",
  ...
  "sourceful/riverflow-v2-fast:free": {
    ...
    label: "Riverflow V2 Fast (Free)",
    displayName: "Riverflow V2 Fast (Free)",
    speed: "fast",
    quality: "medium",
    cost: "low",
    description: "Lower-latency Riverflow variant; tried early for quick replies.",
    badge: "Fastest",
  },
  "sourceful/riverflow-v2-pro:free": {
    id: "sourceful/riverflow-v2-pro:free",
    label: "Riverflow V2 Pro (Free)",
    displayName: "Riverflow V2 Pro (Free)",
    speed: "medium",
    quality: "high",
    cost: "low",
    description: "Higher-quality Riverflow free tier option used as a fallback.",
  },
  "liquid/lfm-2.5-1.2b-thinking:free": {
    id: "liquid/lfm-2.5-1.2b-thinking:free",
    label: "LFM 2.5 1.2B Thinking (Free)",
    displayName: "LFM 2.5 1.2B Thinking (Free)",
    speed: "fast",
    quality: "medium",
    cost: "low",
    description: "Reasoning-focused Liquid LFM 1.2B free-tier model for structured steps.",
  },
  "liquid/lfm-2.5-1.2b-instruct:free": {
    id: "liquid/lfm-2.5-1.2b-instruct:free",
    label: "LFM 2.5 1.2B Instruct (Free)",
    displayName: "LFM 2.5 1.2B Instruct (Free)",
    speed: "fast",
    quality: "medium",
    cost: "low",
    description: "Instruction-tuned Liquid LFM 1.2B; quick, cheap completions.",
  },
  "arcee-ai/trinity-mini:free": {
    ...
    quality: "basic",
    cost: "low",
    description: "Small Arcee Trinity free model for light summaries.",
  },
  "arcee-ai/trinity-large-preview:free": {
    ...
    quality: "high",
    cost: "low",
    description: "Higher-quality Arcee Trinity preview model available on the free tier.",
  },
  "openai/gpt-oss-20b:free": {
    ...
    quality: "high",
    cost: "low",
    description: "OpenAI OSS 20B free model; good balance of quality and latency.",
  },
  "openai/gpt-oss-120b:free": {
    ...
    quality: "high",
    cost: "low",
    description: "Largest free OSS model; used as a last-resort fallback for depth.",
  },
