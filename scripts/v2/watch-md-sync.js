...
const DATABASE_SCHEMA_MD_PATH = path.resolve(__dirname, "../../docs/launch/v2/DATABASE_SCHEMA.md");
...
function startWatcher() {
  ...
  console.log("[md-sync][v2] Watching docs/launch/v2/DATABASE_SCHEMA.md and MASTER_NOTES_PROMPT.md");
}
