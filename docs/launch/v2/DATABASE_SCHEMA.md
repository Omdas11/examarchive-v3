...
_Last synced: 2026-04-08T15:27:04.816Z_
...
| `Syllabus_Table` | ⚠️ Connected with differences | 0 | collection existed; 0 missing attrs created; 1 attr definition mismatch(es); 17 missing expected attr(s); missing: entry_id, college, group, session, year, semester_code, semester_no, credits, marks_total, syllabus_pdf_url, source_reference, status, aliases, keywords, notes, version, last_updated; mismatch: syllabus_content |
