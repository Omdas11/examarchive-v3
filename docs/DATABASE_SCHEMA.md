...
| Bucket ID | Purpose |
|---|---|
| `papers` | Backend configured bucket |
| `notes` | Backend configured bucket |
| `examarchive-syllabus-md-ingestion` | Backend configured bucket |
| `examarchive_question_ingest_assets` | Backend configured bucket |
| `syllabus-files` | Backend configured bucket |
| `avatars` | Backend configured bucket |
| `generated-md-cache` | Backend configured bucket |
| `cached-unit-notes` | Backend configured bucket |
| `cached-solved-papers` | Backend configured bucket |
...
| `Syllabus_Table` | ✅ |
| `Questions_Table` | ✅ |
| `Generated_Notes_Cache` | ✅ |
| `User_Quotas` | ✅ |

<!-- SCHEMA_SYNC_RESOURCES_END -->
...
| `users` | ⚠️ Connected with differences | 0 | ⚠️ 6/17 perfect, 11 different | collection existed; 0/24 missing attrs created; 11 attr definition mismatch(es); string diffs: email: type text → string, size undefined → 320 \| role: type text → string, size undefined → 64 (+9 more) |
| `purchases` | ✅ Perfectly connected | 0 | ✅ 9/9 perfect | collection existed; 0/15 missing attrs created; no mismatches detected; string type/size aligned |
...
| `user_passes` | ✅ Perfectly connected | 0 | ✅ 6/6 perfect | collection existed; 0/11 missing attrs created; no mismatches detected; string type/size aligned |
| `user_badges` | ✅ Perfectly connected | 0 | ✅ 3/3 perfect | collection existed; 0/4 missing attrs created; no mismatches detected; string type/size aligned |
...
**Last Synced:** 2026-05-01T08:21:50.105Z
**Overall Status:** Partial
**Connected:**
- purchases updated successfully.
- user_passes updated successfully.
- user_badges updated successfully.
