...
_Last synced: 2026-05-07T16:03:24.578Z_
...
| `user_passes` | ⚠️ Connected with differences | 0 | undocumented live collection (user_passes); exists in Appwrite but missing from docs/DATABASE_SCHEMA.md |
| `user_badges` | ⚠️ Connected with differences | 0 | undocumented live collection (user_badges); exists in Appwrite but missing from docs/DATABASE_SCHEMA.md |
