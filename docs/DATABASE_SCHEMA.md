...
| `users` | ⚠️ Connected with differences | 2 | ⚠️ 5/16 perfect, 11 different | collection existed; 2/24 missing attrs created; 11 attr definition mismatch(es); string diffs: email: type text → string, size undefined → 320 \| role: type text → string, size undefined → 64 (+9 more) |
...
| `user_passes` | ✅ Perfectly connected | 12 | n/a | collection created; 11/11 missing attrs created; no mismatches detected; string type/size aligned |
| `user_badges` | ✅ Perfectly connected | 4 | n/a | collection existed; 4/4 missing attrs created; no mismatches detected; string type/size aligned |
...
**Last Synced:** 2026-04-25T07:08:30.046Z
