...
Defines the ExamArchive role system, XO scoring, auto-assignment thresholds, demotion rules,
anti-abuse policies, moderation overrides, and the user appeals process.
...
|-------|---------------|------------------------------------------------------------------------|
| 0     | Guest         | Not logged in; read-only access to public pages                        |
| 1     | Viewer        | Registered student; can browse, download, and consume AI jobs          |
| 2     | Contributor   | Actively uploads papers or fixes metadata; unlocks earn bonuses        |
| 3     | Curator       | Trusted data steward; can approve/reject Contributor uploads           |
| 4     | Moderator     | Community enforcer; can flag, hide, and escalate content               |
| 5     | Admin         | Full access; can configure economy, manage roles, override any action  |
